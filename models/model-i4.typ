#import "layout.typ": column_table, conf, fill_in, label_table, plain_table
...
#block(breakable: false, table(
  columns: (1fr, 0.75fr, 1fr),
  "Datum", input.session.date, none,
  "Naam en handtekening voorzitter", input.session.chair, fill_in(height: 4em),
  ..input
    .session
    .members
    .enumerate()
