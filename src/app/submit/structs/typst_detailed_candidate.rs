...
impl TypstDetailedCandidate {
    pub fn try_from(candidate: &Candidate, locale: ModelLocale) -> Result<Self, AppError> {
        ...
        let bsn = if candidate.person.no_bsn_confirmed {
            None
        } else {
            Some(
                candidate
...
mod tests {
    ...
    fn dutch_candidate_with_postal_address() {
        ...
        candidate.person.country_of_residence = Some(CountryCode::from_str("NL").unwrap());
        let typst_candidate =
    ...
    fn non_dutch_candidate_with_representative() {
        ...
        candidate.person.country_of_residence = Some(CountryCode::from_str("BE").unwrap());
    ...
    fn dutch_candidate_without_bsn_confirmed() {
        ...
        candidate.person.no_bsn_confirmed = true;
        candidate.person.bsn = None;
    ...
    fn dutch_candidate_without_bsn() {
        ...
        candidate.person.no_bsn_confirmed = false;
        candidate.person.bsn = None;
