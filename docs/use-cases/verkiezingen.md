...
## Wettelijke basis
Kieskringen: artikel E 1 Kieswet
...
- 1 centraal stembureau: Kiesraad
- 20 kieskringen
...
- 1 centraal stembureau: Kiesraad
- 16 kieskringen (12 provincies, 3 kiescolleges, 1 kiescollege voor niet-ingezetene)
...
- Meerdere kieskringen voor
    ...
    - Zuid-Holland: 4 kieskringen (Den Haag, Rotterdam, Leiden, Dordrecht)
    - Noord-Holland: 3 kieskringen (Den Helder, Haarlem, Amsterdam)
    - Limburg: 1 of 2 kieskringen (Maastricht, Venlo op eigen besluit)

## Waterschapsverkiezingen  / Algemeen bestuur
...
- 21 centrale stembureaus: waterschappen
- Geen kieskringen/ 1 kieskring (per waterschap)

## Gemeenteraadsverkiezingen  
Bij een gemeenteraadsverkiezing kiezen de kiesgerechtigde inwoners de gemeenteraadsleden.

- 342 centrale stembureaus: gemeenten
- Geen kieskringen/ 1 kieskring (per gemeenten)

## Europese verkiezingen  
Bij een verkiezing van het Europees Parlement kiezen de kiesgerechtigden met de Nederlandse nationaliteit of de kiesgerechtigde met de nationaliteit van een EU-lidstaat in Nederland de Nederlandse leden van het Europees Parlement.
- 1 centraal stembureau: Kiesraad
...
De leden worden gekozen door de Nederlandse inwoners van Bonaire, Saba en Sint Eustatius. 
-	3 centraal stembureaus: voor ieder eiland
-	3 kieskringen (1 kieskring per eiland)
 
## Eilandsraden
Vergelijkbaar met gemeenteraadsverkiezingen. Eilandsraad wordt gekozen door de ingezetenen.
-	3 centrale stembureaus: eilanden
-	Geen kieskringen/ 1 kieskring (per eiland)
